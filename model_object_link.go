...
// checks if the ObjectLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ObjectLink{}
...
func (o ObjectLink) ToMap() (map[string]interface{}, error) {

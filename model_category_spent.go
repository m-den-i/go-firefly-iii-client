...
// checks if the CategorySpent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategorySpent{}
...
func (o CategorySpent) ToMap() (map[string]interface{}, error) {

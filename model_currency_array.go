...
// checks if the CurrencyArray type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CurrencyArray{}
...
func (o CurrencyArray) ToMap() (map[string]interface{}, error) {

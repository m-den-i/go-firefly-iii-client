...
// checks if the RecurrenceTransaction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecurrenceTransaction{}
...
func (o *RecurrenceTransaction) GetPiggyBankName() string {
	if o == nil || IsNil(o.PiggyBankName.Get()) {
		var ret string
		return ret
	}
...
func (o *RecurrenceTransaction) SetBillIdNil() {
	o.BillId.Set(nil)
}
...
func (o *RecurrenceTransaction) SetBillNameNil() {
	o.BillName.Set(nil)
}
...
func (o RecurrenceTransaction) ToMap() (map[string]interface{}, error) {

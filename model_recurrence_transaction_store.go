...
// checks if the RecurrenceTransactionStore type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecurrenceTransactionStore{}
...
func (o *RecurrenceTransactionStore) SetBillIdNil() {
	o.BillId.Set(nil)
}
...
func (o RecurrenceTransactionStore) ToMap() (map[string]interface{}, error) {

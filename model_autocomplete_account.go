...
// checks if the AutocompleteAccount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AutocompleteAccount{}
...
func (o AutocompleteAccount) ToMap() (map[string]interface{}, error) {

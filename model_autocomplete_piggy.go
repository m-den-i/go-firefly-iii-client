...
// checks if the AutocompletePiggy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AutocompletePiggy{}
...
func (o *AutocompletePiggy) SetCurrencyName(v string) {
	o.CurrencyName = &v
}
...
func (o AutocompletePiggy) ToMap() (map[string]interface{}, error) {

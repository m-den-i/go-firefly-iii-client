...
// checks if the RecurrenceRepetitionUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecurrenceRepetitionUpdate{}
...
// SetType gets a reference to the given RecurrenceRepetitionType and assigns it to the Type field.
...
func (o RecurrenceRepetitionUpdate) ToMap() (map[string]interface{}, error) {

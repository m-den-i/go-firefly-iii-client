...
// checks if the TransactionSplit type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionSplit{}
...
func (o *TransactionSplit) GetType() TransactionTypeProperty {
	if o == nil {
		var ret TransactionTypeProperty
		return ret
	}
...
func (o *TransactionSplit) GetForeignCurrencyCode() string {
	if o == nil || IsNil(o.ForeignCurrencyCode.Get()) {
		var ret string
		return ret
	}
...
func (o *TransactionSplit) GetForeignCurrencySymbol() string {
	if o == nil || IsNil(o.ForeignCurrencySymbol.Get()) {
		var ret string
		return ret
	}
...
func (o *TransactionSplit) GetForeignCurrencyDecimalPlaces() int32 {
	if o == nil || IsNil(o.ForeignCurrencyDecimalPlaces.Get()) {
		var ret int32
		return ret
	}
...
func (o *TransactionSplit) GetSourceIban() string {
	if o == nil || IsNil(o.SourceIban.Get()) {
		var ret string
		return ret
	}
...
func (o *TransactionSplit) GetDestinationName() string {
	if o == nil || IsNil(o.DestinationName.Get()) {
		var ret string
		return ret
	}
...
func (o *TransactionSplit) GetDestinationIban() string {
	if o == nil || IsNil(o.DestinationIban.Get()) {
		var ret string
		return ret
	}
...
func (o *TransactionSplit) GetBudgetName() string {
	if o == nil || IsNil(o.BudgetName.Get()) {
		var ret string
		return ret
	}
...
func (o *TransactionSplit) GetInternalReference() string {
	if o == nil || IsNil(o.InternalReference.Get()) {
		var ret string
		return ret
	}
...
func (o *TransactionSplit) SetExternalUrlNil() {
...
func (o *TransactionSplit) GetRecurrenceId() int32 {
	if o == nil || IsNil(o.RecurrenceId.Get()) {
		var ret int32
		return ret
	}
...
func (o *TransactionSplit) GetRecurrenceTotal() int32 {
	if o == nil || IsNil(o.RecurrenceTotal.Get()) {
		var ret int32
		return ret
	}
...
func (o *TransactionSplit) GetRecurrenceCount() int32 {
	if o == nil || IsNil(o.RecurrenceCount.Get()) {
		var ret int32
		return ret
	}
...
func (o *TransactionSplit) GetBunqPaymentId() string {
	if o == nil || IsNil(o.BunqPaymentId.Get()) {
		var ret string
		return ret
	}
...
func (o *TransactionSplit) GetImportHashV2() string {
	if o == nil || IsNil(o.ImportHashV2.Get()) {
		var ret string
		return ret
	}
...
func (o *TransactionSplit) GetSepaCountry() string {
	if o == nil || IsNil(o.SepaCountry.Get()) {
		var ret string
		return ret
	}
...
func (o *TransactionSplit) GetSepaBatchId() string {
	if o == nil || IsNil(o.SepaBatchId.Get()) {
		var ret string
		return ret
	}
...
func (o *TransactionSplit) GetInterestDate() time.Time {
	if o == nil || IsNil(o.InterestDate.Get()) {
		var ret time.Time
		return ret
	}
...
func (o *TransactionSplit) GetProcessDate() time.Time {
	if o == nil || IsNil(o.ProcessDate.Get()) {
		var ret time.Time
		return ret
	}
...
func (o *TransactionSplit) SetLatitudeNil() {
	o.Latitude.Set(nil)
}
...
func (o *TransactionSplit) SetLongitudeNil() {
	o.Longitude.Set(nil)
}
...
func (o *TransactionSplit) SetZoomLevelNil() {
	o.ZoomLevel.Set(nil)
}
...
func (o TransactionSplit) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.HasAttachments) {
		toSerialize["has_attachments"] = o.HasAttachments
	}

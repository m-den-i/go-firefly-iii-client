...
// checks if the TransactionStore type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionStore{}
...
func (o *TransactionStore) GetErrorIfDuplicateHash() bool {
	if o == nil || IsNil(o.ErrorIfDuplicateHash) {
		var ret bool
		return ret
	}
...
func (o *TransactionStore) GetGroupTitle() string {
	if o == nil || IsNil(o.GroupTitle.Get()) {
		var ret string
		return ret
	}

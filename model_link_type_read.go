...
// checks if the LinkTypeRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LinkTypeRead{}
...
func (o LinkTypeRead) ToMap() (map[string]interface{}, error) {

...
// checks if the TransactionLinkStore type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionLinkStore{}
...
func (o TransactionLinkStore) ToMap() (map[string]interface{}, error) {

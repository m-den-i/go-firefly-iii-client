...
// checks if the BillArray type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BillArray{}
...
func (o BillArray) ToMap() (map[string]interface{}, error) {

...
// checks if the RuleActionUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuleActionUpdate{}
...
// SetType gets a reference to the given RuleActionKeyword and assigns it to the Type field.
...
func (o RuleActionUpdate) ToMap() (map[string]interface{}, error) {

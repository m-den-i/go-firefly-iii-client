...
// checks if the TransactionSplitStore type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionSplitStore{}
...
func (o *TransactionSplitStore) SetSourceIdNil() {
	o.SourceId.Set(nil)
}
...
func (o *TransactionSplitStore) SetDestinationIdNil() {
...
func (o *TransactionSplitStore) GetPiggyBankName() string {
	if o == nil || IsNil(o.PiggyBankName) {
		var ret string
		return ret
	}
...
func (o *TransactionSplitStore) SetExternalUrlNil() {
...
func (o TransactionSplitStore) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PiggyBankId) {
		toSerialize["piggy_bank_id"] = o.PiggyBankId
	}
	if !IsNil(o.PiggyBankName) {

...
// checks if the RuleRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuleRead{}
...
func (o RuleRead) ToMap() (map[string]interface{}, error) {

...
// checks if the AvailableBudgetStore type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AvailableBudgetStore{}
...
func (o AvailableBudgetStore) ToMap() (map[string]interface{}, error) {

...
// checks if the PreferenceRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PreferenceRead{}
...
func (o PreferenceRead) ToMap() (map[string]interface{}, error) {

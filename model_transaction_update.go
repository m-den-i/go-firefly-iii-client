...
// checks if the TransactionUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionUpdate{}
...
func (o TransactionUpdate) ToMap() (map[string]interface{}, error) {

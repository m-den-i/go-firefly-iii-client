...
// checks if the InsightGroupEntry type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InsightGroupEntry{}
...
func (o InsightGroupEntry) ToMap() (map[string]interface{}, error) {

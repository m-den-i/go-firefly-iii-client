...
// checks if the TransactionSplitUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionSplitUpdate{}
...
// SetType gets a reference to the given TransactionTypeProperty and assigns it to the Type field.
...
func (o *TransactionSplitUpdate) SetExternalUrlNil() {
...
func (o TransactionSplitUpdate) ToMap() (map[string]interface{}, error) {

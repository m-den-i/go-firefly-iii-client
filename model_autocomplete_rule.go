...
// checks if the AutocompleteRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AutocompleteRule{}
...
func (o AutocompleteRule) ToMap() (map[string]interface{}, error) {

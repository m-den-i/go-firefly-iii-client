...
const (
	ALL AccountSearchFieldFilter = "all"
	IBAN AccountSearchFieldFilter = "iban"
	NAME AccountSearchFieldFilter = "name"
	NUMBER AccountSearchFieldFilter = "number"
	ID AccountSearchFieldFilter = "id"
)

// All allowed values of AccountSearchFieldFilter enum

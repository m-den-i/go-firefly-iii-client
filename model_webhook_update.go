...
// SetResponse gets a reference to the given WebhookResponse and assigns it to the Response field.
...
// SetDelivery gets a reference to the given WebhookDelivery and assigns it to the Delivery field.

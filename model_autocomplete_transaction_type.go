...
// checks if the AutocompleteTransactionType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AutocompleteTransactionType{}
...
func (o AutocompleteTransactionType) ToMap() (map[string]interface{}, error) {

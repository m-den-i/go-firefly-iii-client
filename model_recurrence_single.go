...
// checks if the RecurrenceSingle type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecurrenceSingle{}
...
func (o RecurrenceSingle) ToMap() (map[string]interface{}, error) {

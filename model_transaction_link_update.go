...
// checks if the TransactionLinkUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionLinkUpdate{}
...
func (o TransactionLinkUpdate) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.LinkTypeId) {
		toSerialize["link_type_id"] = o.LinkTypeId
	}
	if !IsNil(o.LinkTypeName) {
		toSerialize["link_type_name"] = o.LinkTypeName
	}
	if !IsNil(o.InwardId) {
		toSerialize["inward_id"] = o.InwardId
	}
	if !IsNil(o.OutwardId) {

...
// checks if the AutocompleteCategory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AutocompleteCategory{}
...
func (o AutocompleteCategory) ToMap() (map[string]interface{}, error) {

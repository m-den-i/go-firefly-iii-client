...
**Interest** | Pointer to **NullableString** | Mandatory when type is liability. Interest percentage. | [optional] [default to "0"]
...
`func NewAccountStore(name string, type_ ShortAccountTypeProperty, ) *AccountStore`
...
`func (o *AccountStore) GetMonthlyPaymentDateOk() (*time.Time, bool)`

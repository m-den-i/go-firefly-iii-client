...
------------ | ------------- | ------------- | -------------
**TransactionJournalId** | Pointer to **string** | Transaction journal ID of current transaction (split). | [optional] 
**Type** | Pointer to [**TransactionTypeProperty**](TransactionTypeProperty.md) |  | [optional] 
...
`func (o *TransactionSplitUpdate) GetExternalUrl() string`

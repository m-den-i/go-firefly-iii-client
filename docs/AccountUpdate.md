...
**OpeningBalanceDate** | Pointer to **NullableTime** |  | [optional] 
...
`func (o *AccountUpdate) SetCreditCardType(v CreditCardType)`
...
`func (o *AccountUpdate) GetLiabilityType() LiabilityType`

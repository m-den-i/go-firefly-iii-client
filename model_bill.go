...
type Bill struct {
	...
	NextExpectedMatchDiff NullableString `json:"next_expected_match_diff,omitempty"`
	...
	PaidDates []BillPaidDatesInner `json:"paid_dates,omitempty"`
}
...
func (o *Bill) HasExtensionDate() bool {
	if o != nil && !IsNil(o.ExtensionDate) {
		return true
	}
...
func (o *Bill) GetNextExpectedMatch() time.Time {
	if o == nil || IsNil(o.NextExpectedMatch.Get()) {
		var ret time.Time
		return ret
	}
...
// GetNextExpectedMatchDiff returns the NextExpectedMatchDiff field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *Bill) GetNextExpectedMatchDiff() string {
	if o == nil || IsNil(o.NextExpectedMatchDiff.Get()) {
		var ret string
		return ret
	}
	return *o.NextExpectedMatchDiff.Get()
}

// GetNextExpectedMatchDiffOk returns a tuple with the NextExpectedMatchDiff field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetNextExpectedMatchDiff gets a reference to the given NullableString and assigns it to the NextExpectedMatchDiff field.
func (o *Bill) SetNextExpectedMatchDiff(v string) {
	o.NextExpectedMatchDiff.Set(&v)
}
// SetNextExpectedMatchDiffNil sets the value for NextExpectedMatchDiff to be an explicit nil
func (o *Bill) SetNextExpectedMatchDiffNil() {
	o.NextExpectedMatchDiff.Set(nil)
}
...
func (o *Bill) GetPaidDates() []BillPaidDatesInner {
	if o == nil || IsNil(o.PaidDates) {
		var ret []BillPaidDatesInner
		return ret
	}
	return o.PaidDates
}
...
// SetPaidDates gets a reference to the given []BillPaidDatesInner and assigns it to the PaidDates field.
...
func (o Bill) ToMap() (map[string]interface{}, error) {
	...
	if o.NextExpectedMatchDiff.IsSet() {
		toSerialize["next_expected_match_diff"] = o.NextExpectedMatchDiff.Get()
	}
	...
	// skip: pay_dates is readOnly
	// skip: paid_dates is readOnly

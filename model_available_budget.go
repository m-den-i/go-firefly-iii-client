...
// checks if the AvailableBudget type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AvailableBudget{}
...
func (o *AvailableBudget) GetSpentInBudgets() []BudgetSpent {
	if o == nil || IsNil(o.SpentInBudgets) {
		var ret []BudgetSpent
		return ret
	}
...
func (o *AvailableBudget) GetSpentOutsideBudget() []BudgetSpent {
	if o == nil || IsNil(o.SpentOutsideBudget) {
		var ret []BudgetSpent
		return ret
	}
...
func (o AvailableBudget) ToMap() (map[string]interface{}, error) {
	...
	// skip: spent_in_budgets is readOnly
	// skip: spent_outside_budget is readOnly

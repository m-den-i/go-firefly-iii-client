...
// checks if the TagModelStore type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TagModelStore{}
...
func (o TagModelStore) ToMap() (map[string]interface{}, error) {

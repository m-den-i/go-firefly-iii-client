...
type Recurrence struct {
	...
	LatestDate NullableString `json:"latest_date,omitempty"`
...
func (o *Recurrence) GetType() RecurrenceTransactionType {
	if o == nil || IsNil(o.Type) {
		var ret RecurrenceTransactionType
		return ret
	}
	return *o.Type
}
...
// SetType gets a reference to the given RecurrenceTransactionType and assigns it to the Type field.
...
func (o *Recurrence) GetLatestDate() string {
	if o == nil || IsNil(o.LatestDate.Get()) {
		var ret string
		return ret
	}
...
// SetLatestDate gets a reference to the given NullableString and assigns it to the LatestDate field.

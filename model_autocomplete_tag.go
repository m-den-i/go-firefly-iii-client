...
// checks if the AutocompleteTag type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AutocompleteTag{}
...
func (o AutocompleteTag) ToMap() (map[string]interface{}, error) {

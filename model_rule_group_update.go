...
// checks if the RuleGroupUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuleGroupUpdate{}
...
func (o RuleGroupUpdate) ToMap() (map[string]interface{}, error) {

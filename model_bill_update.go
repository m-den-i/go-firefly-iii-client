...
// checks if the BillUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BillUpdate{}
...
// SetRepeatFreq gets a reference to the given BillRepeatFrequency and assigns it to the RepeatFreq field.
...
func (o BillUpdate) ToMap() (map[string]interface{}, error) {

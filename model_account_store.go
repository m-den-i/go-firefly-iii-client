...
// checks if the AccountStore type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountStore{}
...
func NewAccountStore(name string, type_ ShortAccountTypeProperty) *AccountStore {
	...
	var interest string = "0"
	this.Interest = *NewNullableString(&interest)
	return &this
}
...
func (o *AccountStore) SetLiabilityDirectionNil() {
...
func (o AccountStore) ToMap() (map[string]interface{}, error) {

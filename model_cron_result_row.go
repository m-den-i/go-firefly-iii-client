...
// checks if the CronResultRow type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CronResultRow{}
...
func (o *CronResultRow) GetJobSucceeded() bool {
	if o == nil || IsNil(o.JobSucceeded.Get()) {
		var ret bool
		return ret
	}
...
func (o *CronResultRow) GetJobErrored() bool {
	if o == nil || IsNil(o.JobErrored.Get()) {
		var ret bool
		return ret
	}
...
func (o CronResultRow) ToMap() (map[string]interface{}, error) {

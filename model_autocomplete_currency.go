...
// checks if the AutocompleteCurrency type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AutocompleteCurrency{}
...
func (o AutocompleteCurrency) ToMap() (map[string]interface{}, error) {

...
// checks if the PiggyBankArray type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PiggyBankArray{}
...
func (o PiggyBankArray) ToMap() (map[string]interface{}, error) {

...
// checks if the RecurrenceArray type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecurrenceArray{}
...
func (o RecurrenceArray) ToMap() (map[string]interface{}, error) {

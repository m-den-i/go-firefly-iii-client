...
// checks if the RuleGroupStore type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuleGroupStore{}
...
func (o RuleGroupStore) ToMap() (map[string]interface{}, error) {

...
// checks if the PreferenceSingle type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PreferenceSingle{}
...
func (o PreferenceSingle) ToMap() (map[string]interface{}, error) {

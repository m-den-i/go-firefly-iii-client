...
// checks if the RuleGroupRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuleGroupRead{}
...
func (o RuleGroupRead) ToMap() (map[string]interface{}, error) {

...
// checks if the TransactionLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionLink{}
...
func (o TransactionLink) ToMap() (map[string]interface{}, error) {

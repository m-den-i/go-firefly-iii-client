...
*/
func (a *TagsApiService) DeleteTag(ctx context.Context, tag string) ApiDeleteTagRequest {
	return ApiDeleteTagRequest{
		ApiService: a,
		ctx: ctx,
		tag: tag,
...
func (a *TagsApiService) DeleteTagExecute(r ApiDeleteTagRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/tags/{tag}"
...
// Unique identifier associated with this request.
func (r ApiGetTagRequest) XTraceId(xTraceId string) ApiGetTagRequest {
	r.xTraceId = &xTraceId
	return r
}
...
func (r ApiGetTagRequest) Execute() (*TagSingle, *http.Response, error) {
...
*/
func (a *TagsApiService) GetTag(ctx context.Context, tag string) ApiGetTagRequest {
	return ApiGetTagRequest{
		ApiService: a,
		ctx: ctx,
		tag: tag,
...
// Execute executes the request
//  @return TagSingle
func (a *TagsApiService) GetTagExecute(r ApiGetTagRequest) (*TagSingle, *http.Response, error) {
	var (
...
// Unique identifier associated with this request.
func (r ApiListAttachmentByTagRequest) XTraceId(xTraceId string) ApiListAttachmentByTagRequest {
	r.xTraceId = &xTraceId
	return r
}
...
func (r ApiListAttachmentByTagRequest) Execute() (*AttachmentArray, *http.Response, error) {
...
*/
func (a *TagsApiService) ListAttachmentByTag(ctx context.Context, tag string) ApiListAttachmentByTagRequest {
	return ApiListAttachmentByTagRequest{
		ApiService: a,
		ctx: ctx,
		tag: tag,
...
func (a *TagsApiService) ListAttachmentByTagExecute(r ApiListAttachmentByTagRequest) (*AttachmentArray, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localVarPath := localBasePath + "/v1/tags/{tag}/attachments"
	localVarPath = strings.Replace(localVarPath, "{"+"tag"+"}", url.PathEscape(parameterValueToString(r.tag, "tag")), -1)
...
// Unique identifier associated with this request.
func (r ApiListTagRequest) XTraceId(xTraceId string) ApiListTagRequest {
	r.xTraceId = &xTraceId
	return r
}
...
func (r ApiListTagRequest) Execute() (*TagArray, *http.Response, error) {
...
*/
func (a *TagsApiService) ListTag(ctx context.Context) ApiListTagRequest {
	return ApiListTagRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return TagArray
func (a *TagsApiService) ListTagExecute(r ApiListTagRequest) (*TagArray, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
// Unique identifier associated with this request.
func (r ApiListTransactionByTagRequest) XTraceId(xTraceId string) ApiListTransactionByTagRequest {
	r.xTraceId = &xTraceId
	return r
}
...
func (r ApiListTransactionByTagRequest) Execute() (*TransactionArray, *http.Response, error) {
...
*/
func (a *TagsApiService) ListTransactionByTag(ctx context.Context, tag string) ApiListTransactionByTagRequest {
	return ApiListTransactionByTagRequest{
		ApiService: a,
		ctx: ctx,
		tag: tag,
...
func (a *TagsApiService) ListTransactionByTagExecute(r ApiListTransactionByTagRequest) (*TransactionArray, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localVarPath := localBasePath + "/v1/tags/{tag}/transactions"
	localVarPath = strings.Replace(localVarPath, "{"+"tag"+"}", url.PathEscape(parameterValueToString(r.tag, "tag")), -1)
...
// Unique identifier associated with this request.
func (r ApiStoreTagRequest) XTraceId(xTraceId string) ApiStoreTagRequest {
	r.xTraceId = &xTraceId
	return r
}

func (r ApiStoreTagRequest) Execute() (*TagSingle, *http.Response, error) {
...
*/
func (a *TagsApiService) StoreTag(ctx context.Context) ApiStoreTagRequest {
	return ApiStoreTagRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return TagSingle
func (a *TagsApiService) StoreTagExecute(r ApiStoreTagRequest) (*TagSingle, *http.Response, error) {
	var (
...
func (r ApiUpdateTagRequest) Execute() (*TagSingle, *http.Response, error) {
...
*/
func (a *TagsApiService) UpdateTag(ctx context.Context, tag string) ApiUpdateTagRequest {
	return ApiUpdateTagRequest{
		ApiService: a,
		ctx: ctx,
		tag: tag,
...
// Execute executes the request
//  @return TagSingle
func (a *TagsApiService) UpdateTagExecute(r ApiUpdateTagRequest) (*TagSingle, *http.Response, error) {
	var (

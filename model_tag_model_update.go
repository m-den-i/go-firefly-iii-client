...
// checks if the TagModelUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TagModelUpdate{}
...
func (o TagModelUpdate) ToMap() (map[string]interface{}, error) {

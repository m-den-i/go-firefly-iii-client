...
// checks if the BudgetLimitArray type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BudgetLimitArray{}
...
func (o BudgetLimitArray) ToMap() (map[string]interface{}, error) {
